...
df = df[(df['Year'] >= 2006) & (df['OFNS_DESC'].isin(['MURDER & NON-NEGL. MANSLAUGHTER']))]
...
plt.title('Total Murders Per Year Per Borough')
...
plt.savefig(os.path.join(base_path, 'charts', 'murder_rates_plot.jpg'))
plt.show()
